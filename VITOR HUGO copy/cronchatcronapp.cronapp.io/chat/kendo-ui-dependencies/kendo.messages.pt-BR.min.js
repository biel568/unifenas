(function(f) {
    ...
    (function($, undefined) {
        ...
        if (kendo.ui.ColorPicker) {
            kendo.ui.ColorPicker.prototype.options.messages = $.extend(!0, kendo.ui.ColorPicker.prototype.options.messages, {
                "apply": "Aplicar",
                "cancel": "Cancelar"
            })
        }
        if (kendo.ui.ColumnMenu) {
            kendo.ui.ColumnMenu.prototype.options.messages = $.extend(!0, kendo.ui.ColumnMenu.prototype.options.messages, {
        ...
        if (kendo.ui.Editor) {
            kendo.ui.Editor.prototype.options.messages = $.extend(!0, kendo.ui.Editor.prototype.options.messages, {
                "bold": "Negrito",
                "italic": "Itálico",
        ...
        if (kendo.ui.FileBrowser) {
            kendo.ui.FileBrowser.prototype.options.messages = $.extend(!0, kendo.ui.FileBrowser.prototype.options.messages, {
                "uploadFile": "Upload",
        ...
        if (kendo.ui.FilterCell) {
            kendo.ui.FilterCell.prototype.options.messages = $.extend(!0, kendo.ui.FilterCell.prototype.options.messages, {
                "isTrue": "É verdade",
                "isFalse": "É falso",
                "filter": "Filtrar",
                "clear": "Limpar",
        ...
        if (kendo.ui.FilterCell) {
            kendo.ui.FilterCell.prototype.options.operators = $.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
                "string": {
                    "eq": "É igual a",
                    "neq": "Não é igual a",
        ...
        if (kendo.ui.FilterMenu) {
            kendo.ui.FilterMenu.prototype.options.messages = $.extend(!0, kendo.ui.FilterMenu.prototype.options.messages, {
        ...
        if (kendo.ui.FilterMenu) {
            kendo.ui.FilterMenu.prototype.options.operators = $.extend(!0, kendo.ui.FilterMenu.prototype.options.operators, {
                "string": {
                    "eq": "É igual a",
                    "neq": "Não é igual a",
                    "startswith": "Começa com",
        ...
        if (kendo.ui.FilterMultiCheck) {
            kendo.ui.FilterMultiCheck.prototype.options.messages = $.extend(!0, kendo.ui.FilterMultiCheck.prototype.options.messages, {
        ...
        if (kendo.ui.Gantt) {
            kendo.ui.Gantt.prototype.options.messages = $.extend(!0, kendo.ui.Gantt.prototype.options.messages, {
                "actions": {
        ...
        if (kendo.ui.Grid) {
            kendo.ui.Grid.prototype.options.messages = $.extend(!0, kendo.ui.Grid.prototype.options.messages, {
                "commands": {
        ...
        if (kendo.ui.Groupable) {
            kendo.ui.Groupable.prototype.options.messages = $.extend(!0, kendo.ui.Groupable.prototype.options.messages, {
                "empty": "Arraste aqui o cabeçalho de uma coluna para agrupar por esta coluna"
            })
        }
        if (kendo.ui.NumericTextBox) {
            kendo.ui.NumericTextBox.prototype.options = $.extend(!0, kendo.ui.NumericTextBox.prototype.options, {
                "upArrowText": "Aumentar valor",
                "downArrowText": "Diminuir valor"
            })
        }
        if (kendo.ui.MediaPlayer) {
            kendo.ui.MediaPlayer.prototype.options.messages = $.extend(!0, kendo.ui.MediaPlayer.prototype.options.messages, {
                "pause": "Pausar",
                "play": "Iniciar",
                "mute": "Mudo",
                "unmute": "Ativar som",
        ...
        if (kendo.ui.Pager) {
            kendo.ui.Pager.prototype.options.messages = $.extend(!0, kendo.ui.Pager.prototype.options.messages, {
                "allPages": "Todos",
        ...
        if (kendo.ui.TreeListPager) {
            kendo.ui.TreeListPager.prototype.options.messages = $.extend(!0, kendo.ui.TreeListPager.prototype.options.messages, {
                "allPages": "Todos",
                "display": "Exibindo itens {0} - {1} de {2}",
                "empty": "Nenhum registro encontrado.",
                "page": "Página",
        ...
        if (kendo.ui.PivotGrid) {
            kendo.ui.PivotGrid.prototype.options.messages = $.extend(!0, kendo.ui.PivotGrid.prototype.options.messages, {
        ...
        if (kendo.ui.PivotFieldMenu) {
            kendo.ui.PivotFieldMenu.prototype.options.messages = $.extend(!0, kendo.ui.PivotFieldMenu.prototype.options.messages, {
        ...
        if (kendo.ui.RecurrenceEditor) {
            kendo.ui.RecurrenceEditor.prototype.options.messages = $.extend(!0, kendo.ui.RecurrenceEditor.prototype.options.messages, {
                "frequencies": {
                    "never": "Nunca",
                    "hourly": "Por hora",
                    "daily": "Diariamente",
        ...
        if (kendo.ui.Scheduler) {
            kendo.ui.Scheduler.prototype.options.messages = $.extend(!0, kendo.ui.Scheduler.prototype.options.messages, {
                "allDay": "dia inteiro",
                "date": "Data",
                "event": "Evento",
                "time": "Hora",
        ...
        if (kendo.spreadsheet && kendo.spreadsheet.messages.borderPalette) {
            kendo.spreadsheet.messages.borderPalette = $.extend(!0, kendo.spreadsheet.messages.borderPalette, {
        ...
        if (kendo.spreadsheet && kendo.spreadsheet.messages.dialogs) {
            kendo.spreadsheet.messages.dialogs = $.extend(!0, kendo.spreadsheet.messages.dialogs, {
                "apply": "Aplicar",
                "save": "Salvar",
                "cancel": "Cancelar",
                "remove": "Excluir",
        ...
        if (kendo.spreadsheet && kendo.spreadsheet.messages.filterMenu) {
            kendo.spreadsheet.messages.filterMenu = $.extend(!0, kendo.spreadsheet.messages.filterMenu, {
        ...
        if (kendo.spreadsheet && kendo.spreadsheet.messages.toolbar) {
            kendo.spreadsheet.messages.toolbar = $.extend(!0, kendo.spreadsheet.messages.toolbar, {
        ...
        if (kendo.spreadsheet && kendo.spreadsheet.messages.view) {
            kendo.spreadsheet.messages.view = $.extend(!0, kendo.spreadsheet.messages.view, {
                "errors": {
        ...
        if (kendo.ui.Slider) {
            kendo.ui.Slider.prototype.options = $.extend(!0, kendo.ui.Slider.prototype.options, {
                "increaseButtonTitle": "Aumentar",
                "decreaseButtonTitle": "Diminuir"
            })
        }
        if (kendo.ui.TreeList) {
            kendo.ui.TreeList.prototype.options.messages = $.extend(!0, kendo.ui.TreeList.prototype.options.messages, {
        ...
        if (kendo.ui.TreeView) {
            kendo.ui.TreeView.prototype.options.messages = $.extend(!0, kendo.ui.TreeView.prototype.options.messages, {
                "loading": "Carregando...",
        ...
        if (kendo.ui.Upload) {
            kendo.ui.Upload.prototype.options.localization = $.extend(!0, kendo.ui.Upload.prototype.options.localization, {
                "select": "Selecionar...",
                "cancel": "Cancelar",
                "retry": "Tentar novamente",
                "remove": "Remover",
        ...
        if (kendo.ui.Validator) {
            kendo.ui.Validator.prototype.options.messages = $.extend(!0, kendo.ui.Validator.prototype.options.messages, {
        ...
        if (kendo.ui.progress) {
            kendo.ui.progress.messages = $.extend(!0, kendo.ui.progress.messages, {
                loading: "Carregando..."
            })
        }
        if (kendo.ui.Dialog) {
            kendo.ui.Dialog.prototype.options.messages = $.extend(!0, kendo.ui.Dialog.prototype.options.localization, {
                "close": "Fechar"
            })
        }
        if (kendo.ui.Alert) {
            kendo.ui.Alert.prototype.options.messages = $.extend(!0, kendo.ui.Alert.prototype.options.localization, {
                "okText": "OK"
            })
        }
        if (kendo.ui.Confirm) {
            kendo.ui.Confirm.prototype.options.messages = $.extend(!0, kendo.ui.Confirm.prototype.options.localization, {
                "okText": "OK",
                "cancel": "Cancelar"
            })
        }
        if (kendo.ui.Prompt) {
            kendo.ui.Prompt.prototype.options.messages = $.extend(!0, kendo.ui.Prompt.prototype.options.localization, {
                "okText": "OK",
                "cancel": "Cancelar"
            })
        }
