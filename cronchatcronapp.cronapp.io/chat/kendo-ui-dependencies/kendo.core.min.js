    ...
    (function($, window, undefined) {
        ...
        Class.extend = function(proto) {
            ...
            for (member in proto) {
                if (proto[member] != null && proto[member].constructor === Object) {
                    fn[member] = extend(!0, {}, base.prototype[member], proto[member])
                } else {
        ...
        var Observable = Class.extend({
            ...
            bind: function(eventName, handlers, one) {
                var that = this,
                    idx, eventNames = typeof eventName === STRING ? [eventName] : eventName,
                    length, original, handler, handlersIsFunction = typeof handlers === FUNCTION,
                    events;
            ...
            first: function(eventName, handlers) {
                var that = this,
                    idx, eventNames = typeof eventName === STRING ? [eventName] : eventName,
                    length, handler, handlersIsFunction = typeof handlers === FUNCTION,
                    events;
                for (idx = 0, length = eventNames.length; idx < length; idx++) {
                    eventName = eventNames[idx];
                    handler = handlersIsFunction ? handlers : handlers[eventName];
        ...
        (function() {
            ...
            function formatNumber(number, format, culture) {
                ...
                var numberFormat = culture.numberFormat,
                    ...
                    literals = [],
                    symbol, isCurrency, isPercent, customPrecision, formatAndPrecision, negative = number < 0,
                    integer, fraction, integerLength, fractionLength, replacement = EMPTY,
                    value = EMPTY,
                    idx, length, ch, hasGroup, hasNegativeFormat, decimalIndex, sharpIndex, zeroIndex, hasZero, hasSharp, percentIndex, currencyIndex, startZeroIndex, start = -1,
                    end;
                if (number === undefined) {
                    return EMPTY
                }
            ...
            kendo._outerWidth = function(element, includeMargin) {
                return $(element).outerWidth(includeMargin || !1) || 0
            };
            kendo._outerHeight = function(element, includeMargin) {
                return $(element).outerHeight(includeMargin || !1) || 0
            };
        ...
        (function() {
                ...
                for (; idx < length; idx++) {
                    ...
                    if (literal) {
                        ...
                        if (ch === 'd') {
                            ...
                            day = count < 3 ? getNumber(2) : getIndexByName(calendar._lowerDays[count == 3 ? 'namesAbbr' : 'names'], !0);
                            ...
                            month = count < 3 ? getNumber(2) : getIndexByName(calendar._lowerMonths[count == 3 ? 'namesAbbr' : 'names'], !0);
            ...
            kendo.parseDate = function(value, formats, culture) {
                return internalParseDate(value, formats, culture, !1)
            };
            kendo.parseExactDate = function(value, formats, culture) {
                return internalParseDate(value, formats, culture, !0)
            };
        ...
        function wrap(element, autosize) {
            var browser = support.browser,
                percentage, outerWidth = kendo._outerWidth,
        ...
        function deepExtendOne(destination, source) {
            var ObservableArray = kendo.data.ObservableArray,
                ...
                property, propValue, propType, propInit, destProp;
        ...
        function scrollLeft(element, value) {
            ...
            try {
                ...
                support.tbodyInnerHtml = !0
            } catch (e) {
                support.tbodyInnerHtml = !1
            }
            support.touch = 'ontouchstart' in window;
            var docStyle = document.documentElement.style;
            var transitions = support.transitions = !1,
                transforms = support.transforms = !1,
                ...
                for (var agent in agentRxs) {
                    if (agentRxs.hasOwnProperty(agent)) {
                        ...
                        if (match) {
                            ...
                            os = {};
                            os.device = agent;
                            os.tablet = testRx(agent, formFactorRxs, !1);
                ...
                for (var agent in browserRxs) {
                    if (browserRxs.hasOwnProperty(agent)) {
                        ...
                        if (match) {
                            browser = {};
                            browser[agent] = !0;
                            browser[match[1].toLowerCase().split(' ')[0].split('/')[0]] = !0;
        ...
        if (!('kendoAnimate' in $.fn)) {
            extend($.fn, {
                ...
                kendoAddClass: function(classes, options) {
                    return kendo.toggleClass(this, classes, options, !0)
                },
                kendoRemoveClass: function(classes, options) {
                    return kendo.toggleClass(this, classes, options, !1)
                },
        ...
        function htmlEncode(value) {
            return ('' + value).replace(ampRegExp, '&amp;').replace(aposRegExp, '&#39;')
        }
        ...
        var wrapExpression = function(members, paramName) {
                var result = paramName || 'd',
                    index, idx, length, member, count = 1;
        ...
        var Widget = Observable.extend({
            init: function(element, options) {
                ...
                options = that.options = extend(!0, {}, that.options, options);
                if (dataSource) {
        ...
        var MouseEventNormalizer = {
            setupMouseMute: function() {
                ...
                for (; idx < length; idx++) {
                    element.addEventListener(MOUSE_EVENTS[idx], handler, !0)
                }
            },
            muteMouse: function(e) {
                MouseEventNormalizer.captureMouse = !0;
                if (e.data.bustClick) {
                    MouseEventNormalizer.bustClick = !0
                }
